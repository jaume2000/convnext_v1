...
#SBATCH --error=logs/train_shared_convnext_allstages_%j.err

# Shared-only ConvNeXt: 1 block per stage, looped [3, 3, 9, 3] (4 shared blocks total).
#
# Submit from the repo root:
#   source .env && sbatch --account="$SLURM_ACCOUNT" jobs/train_shared_convnext_allstages.sh
#
...
# From .env (or override): EXPERIMENT_NAME=shared_convnextv1_allstages_imagenet
EXPERIMENT_NAME="${EXPERIMENT_NAME:-shared_convnextv1_allstages_imagenet}"
...
TRAIN_SCRIPT="${TRAIN_SCRIPT:-scripts/train_shared_convnext_allstages.py}"
