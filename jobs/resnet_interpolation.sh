...
#SBATCH --output=logs/resnet_interpolation_%j.out
#SBATCH --error=logs/resnet_interpolation_%j.err

# Stage-3 residual schedule sweep on pretrained ResNet-50.
# Experiment list lives in scripts/resnet_interpolation.py (EXPERIMENTS).
#
# Submit from the repo root:
#   source .env && sbatch --account="$SLURM_ACCOUNT" jobs/resnet_interpolation.sh
# Or simply:
#   bash jobs/resnet_interpolation.sh
...
SCRIPT="${PROJECT_ROOT}/scripts/resnet_interpolation.py"
