...
#SBATCH --output=logs/train_shared_convnext_D27_%j.out
#SBATCH --error=logs/train_shared_convnext_D27_%j.err

# Shared-only ConvNeXt: one stage3 block looped 27 times (from scratch, not D9 finetune).
#
...
TRAIN_SCRIPT="${TRAIN_SCRIPT:-scripts/train_shared_convnext_D27.py}"
