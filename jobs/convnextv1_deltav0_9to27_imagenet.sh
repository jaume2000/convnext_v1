...
#SBATCH --error=logs/convnextv1_deltav0_9to27_imagenet_%j.err

# Loads the shared D=9 ConvNeXt, expands stage3 to 27 Euler steps (EU=1/3), and
# fine-tunes zero-init deltas. Writes to outputs/convnextv1_deltav0_9to27_imagenet.
...
TRAIN_SCRIPT="${TRAIN_SCRIPT:-scripts/train_convnextv1_deltav0_9to27_imagenet.py}"
