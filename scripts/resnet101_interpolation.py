...
EXPERIMENTS = [
    {
        "name": f"resnet101_R{r}_ES{1 / r:g}_{m}_{wi}",
        "repeats": r,
        "euler_step": 1 / r,
        "method": m,
...
EXPERIMENTS += [
    {
        "name": f"resnet101_R10_ES0.1_{m}_{wi}",
        "repeats": 10,
        "euler_step": 0.1,
        "method": m,
        "weight_interpolation": wi,
...
EXPERIMENTS += [
    {
        "name": f"resnet101_R10_ES1_RK1_{wi}",
        "repeats": 10,
        "euler_step": 1,
        "method": "RK1",
        "weight_interpolation": wi,
...
EXPERIMENTS += [
    {
        "name": f"resnet101_R100_ES1_RK1_{wi}",
        "repeats": 100,
        "euler_step": 1,
        "method": "RK1",
        "weight_interpolation": wi,
...
if __name__ == "__main__":
    ...
    print("\n=== summary ===")
    print(f"{'name':<40} {'wi':<10} {'method':<6} {'euler':>8} {'top1':>10} {'loss':>10}")
    for row in results:
        print(
            f"{row['name']:<40} {row['weight_interpolation']:<10} {row['method']:<6} "
