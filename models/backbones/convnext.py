...
class ConvNextV1(nn.Module):
    def __init__(self):
        ...
        self.stage1 = nn.Sequential(*[ConvnextBlock(96, 0.1) for _ in range(3)],
            nn.Conv2d(96, 96*2, kernel_size=2, stride=2, padding=0),
            nn.LayerNorm(96*2))
        self.stage2 = nn.Sequential(*[ConvnextBlock(96*2, 0.4) for _ in range(3)],
            nn.Conv2d(96*2, 96*4, kernel_size=2, stride=2, padding=0),
            nn.LayerNorm(96*4))
        self.stage3 = nn.Sequential(*[ConvnextBlock(96*4, 0.5) for _ in range(9)],
